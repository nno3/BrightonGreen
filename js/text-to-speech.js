...
function initTextToSpeech() {
    ...
    function getReadableElements() {
        ...
        // Get all readable elements from the page
        const commonSelectors = 'h1, h2, h3, h4, h5, h6, p, .lead, .attraction-content h3, .attraction-content p, .lead.text-muted, .attraction-badge, .activity-title, .activity-description, .time-heading';
